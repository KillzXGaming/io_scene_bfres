...
def saveTextures(textures, filepath):
    for tex in textures:
        if tex.format in formats and tex.numFaces < 2:
            ...
            astcPath = os.path.join(directory, tex.name+".astc")
